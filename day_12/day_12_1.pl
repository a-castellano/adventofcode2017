#!/usr/bin/perl
# Álvaro Castellano Vela - 12/12/2017
...
my @set_with_ID_zero = get_sets( \%sets, 0 );
my $keys_in_set = keys %{ $sets{ $set_with_ID_zero[0] } };
print "Programs are in the group that contains program ID 0 -> $keys_in_set\n";
